...
export async function getTopGames(accessToken?: string): Promise<{ data: TopGame[] }> {
  // const accessToken = await getAccessToken();
...
export async function getEmotes(userId: string, accessToken?: string): Promise<Emotes[]> {
  // const accessToken = await getAccessToken();
...
export async function getUserClips(userId: string, accessToken?: string): Promise<any> {
  // const accessToken = await getAccessToken();
